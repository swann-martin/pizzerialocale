...
export function VegetarianIcon(props: { className?: string }) {
  return (
    <svg
      fill="currentColor"
      height="200px"
...
export function Phone(props: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
